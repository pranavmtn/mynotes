...
export function PlanTab({
  ...
  onToggleStepInTimeline: (ideaId: string, planId: string, stepId: string) => void;
  ...
  if (openIdea) {
    return (
      <IdeaDetail
        ...
        onToggleStepInTimeline={(planId, stepId) =>
          onToggleStepInTimeline(openIdea.id, planId, stepId)
        }
